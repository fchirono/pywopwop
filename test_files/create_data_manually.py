...
myWopwopData.geometry_comment = 'Test file for pywopwop2 - geometry'
...
myWopwopData.loading_comment = 'Test file for pywopwop2 - loading'


# adds zone 1 info - mesh coords, normal coords, loading data
myWopwopData.add_StructuredConstantZone(name, XYZ_coord, normal_coord,
                                        loading_data=loading_data,
                                        calc_thickness_noise=True,)

# add zone 2 - no loading data
myWopwopData.add_StructuredConstantZone(name[:-1] + '2', XYZ_coord+1,
                                        normal_coord+1,
                                        calc_thickness_noise=True)

# add zone 3 - loading data, no thickness noise
myWopwopData.add_StructuredConstantZone(name[:-1] + '3', XYZ_coord+2,
                                        normal_coord+2,
