...
class PWWPatch:
    ...
    # **********************************************************************
    def add_StructuredZone(self, name, geometry_tuple,
        ...
        geometry_tuple : tuple (XYZ_coord, normal_coord)
            Tuple containing geometry information. Their expected shape will
        ...
        loading_tuple : tuple (loading_data), optional
            Tuple containing loading information. Their expected shape will depend on
            'loading_time_type' and 'loading_data_type' attributes of the
            parent PWWPatch instance; see Notes below. Default is empty tuple.
        ...
        If  'geometry_time_type' is 'constant', the geometry information are:
        ...
        # unpack input tuple
        XYZ_coord, normal_coord = geometry_tuple
